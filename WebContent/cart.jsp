...
<th>Free Delivery</th>
<th class="th-allignright">Price</th></tr>
<c:set var="sum" value="${0}"></c:set>
            ...
            <tr>
                  ...
                  <td class="th-allignright"><fmt:setLocale value="en_IN" scope="session"/><fmt:formatNumber type="currency" value="${cart.price}"/></td>
            ...
            <td class="th-allignright"><fmt:setLocale value="en_IN"/><fmt:formatNumber type="currency" value="${sum}"/></td>
            </tr>
